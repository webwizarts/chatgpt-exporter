  ...
  return (
    <ModalWrapper onClick={closeModal}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        ...
        <EditorContainer>
          <EditorHeader>       
            <EditorHeaderButton onClick={handleCopy} tooltip="Copy to Clipboard" tooltipOnClick="Copied"><img src={copyImg} alt="copy" width={20} /></EditorHeaderButton>
            <EditorHeaderButton onClick={handleDownloadTXT} tooltip="Download as TXT Format" tooltipOnClick="Downloaded"><img src={txtImg} alt="txt" width={20} /></EditorHeaderButton>
            <EditorHeaderButton onClick={handleDownloadPDF} tooltip="Download as PDF" tooltipOnClick="Downloaded"><img src={pdfImg} alt="pdf" width={20} /></EditorHeaderButton>
